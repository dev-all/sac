        ...
        public ActionResult Agregar(LocalidadModelView oLocalidadModelView)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    {
                        servicioLocalidad._mensaje("El país se registró correctamente", "ok");
                    }
                    else if (respuesta == -1) // paso algo
                    {
                        servicioLocalidad._mensaje("El país ingresado No se pudo registrar", "error");
                    }
                    else //ya existe
                    {
                        servicioLocalidad._mensaje("El país que intenta resitrar ya se encuentra cargado", "error");
                    }
        ...
        public ActionResult Editar(LocalidadModelView oLocalidadModelView)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    oLocalidadModel.Codigo = oLocalidad.Codigo;
