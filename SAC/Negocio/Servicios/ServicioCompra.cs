                        ...
                        else
                        {
                            ...
                            else
                            {
                                ...
                                if (nuevoPagoRegistrado != null)
                                {
                                    ...
                                    CajaModel inCajaModel = oServicioCaja.GuardarCaja(oCajaModel);
                                    ...
                                    if (oMediosPago.idCuentaBancariaSelec_ > 0)
                                    {
                                        ...
                                        {
                                            var asientoBanco = oServicioContable.InsertAsientoContable(bancoCuenta.Codigo, pagoBancoCuentaBancaria.Importe, asiento, nuevoPagoRegistrado, 0);
                                    ...
                                    if (oMediosPago.montoEfectivo_ != 0)
                                    {
                                        ...
                                        if (pagoEfectivo.Id > 0)
                                        {
                                            ...
                                            var asientoCaja = oServicioContable.InsertAsientoContable(alias, importeEfectivo, asiento, nuevoPagoRegistrado, 0);
                                    ...
                                    if (oMediosPago.idTarjetaSelec_ != 0)
                                    {
                                        ...
                                        if (pagoTarjeta.Monto > 0)
                                        {
                                            ...
                                            var asientoBanco = oServicioContable.InsertAsientoContable("TARJE", montoPagadoConTarjeta, asiento, nuevoPagoRegistrado, 0);
                                            if (asientoBanco != null) { oServicioImputacion.AsintoContableGeneral(asientoBanco); }
                                        }
                                    ...
                                    {
                                        var asientoBanco = oServicioContable.InsertAsientoContable("CHTER", importePagoEnCheque, asiento, nuevoPagoRegistrado, 0);
                                        if (asientoBanco != null) { oServicioImputacion.AsintoContableGeneral(asientoBanco); }
                                    }
